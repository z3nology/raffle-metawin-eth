...
export default function BuyEntry() {
  ...
  useEffect(() => {
    window.document.title =
      "Win Bored Ape Yacht Club " + "#" + router.query.raffleId + " at Metawin"; // Set your desired title here
  }, [router]);
            ...
            {Number(filterDataByID[0]?.endTime) < Number(currentTime) && (
              <div className="w-full flex items-center justify-center">
                <div className="flex flex-col items-center justify-center">
                  <p className="uppercase mt-4 text-sm text-center text-white font-bold">
