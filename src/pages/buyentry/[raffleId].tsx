...
export default function Buyentry() {
  ...
  const handleBuyFunc = async () => {
    const pricesData = await NFTCONTRACT.prices(router.query.raffleId, 0);
    const ticketPrice = Number(
      parseFloat(ethers.utils.formatEther(pricesData.price.toString()))
    );
    console.log(router.query.raffleId, pricesData.price);
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full mt-24 lg:mt-40 xl:px-[300px] px-[10px] md:px-[100px]">
