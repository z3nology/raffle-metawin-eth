  ...
  return (
    <div className="flex flex-col items-center justify-center w-full mt-20">
      <div className="flex gap-5">
        <div className="w-[600px] h-[400px] rounded-xl">
          <img
            src="/img/cardImg.png"
          ...
          <p className="text-white text-[13px] mt-3 py-3 "></p>
        </div>
        <div
          className="w-full max-w-[900px]  min-w-[400px] transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all
                min-h-[70vh] z-50 bg-[#04111d]"
        >
          ...
          <div className="grid w-full grid-cols-2 gap-3 mt-2">
            <div className="flex flex-col justify-start items-center bg-[#131f2a] rounded-lg p-3 hover:scale-[1.02] duration-150 transition-all">
              ...
              <h1 className="text-xl font-bold text-white uppercase">entry</h1>
